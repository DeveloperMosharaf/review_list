...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="https://escortbabyliion.net/review_list/957882/new//images/escortBabylon_favicon.ico" rel="shortcut icon" type="image/x-icon">
 ...
 <script src="jquery.min.js.download"></script>
    <script src="custom-jquery.js.download"></script>
...
<!-- /Yandex.Metrika counter -->
    ...
    <img src="lor_title.png" class="lortitle">
    <h1>You are logged in as:</h1>
    <span></span>
</div></div>
 >

        <header id="topImageHeader"><img src="ebMainLogo.png" id="topHeaderImage">
<!--{{page}}/{{curr_page}}-->
<nav id="topNavigation">
    <div class="postsLinkNavigation">
        <a href="#/posts_list/7073731547/1">
            <img src="ebMainNavPostsActive3.png" style="display:none;">
            <img src="ebMainNavPosts3.png" style="display:block;">
        </a>
    </div>
    <div class="infoLinkNavigation">
        <a href="#/info_stats/7073731547">
            <img src="ebMainNavInfoActive3.png" style="display:none;">
            <img src="ebMainNavInfo3.png" style="display:block;">
        </a>
    </div>

    <div class="picturesLinkNavigation">
        <a href="#/image_list/7073731547">
            <img src="ebMainNavPicturesActive3.png" style="display:none;">
            <img src="ebMainNavPictures3.png" style="display:block;">
        </a>
    </div>
    <div class="reviewsLinkNavigation">
        <a href="#/review_list/7073731547">
            <img src="ebMainNavReviewsActive3.png" style="display:block;">
            <img src="ebMainNavReviews3.png" style="display:none;">
        </a>
    </div>
    <div class="commentLinkNavigation">
        <a href="#/comments_list/7073731547">
            <img src="ebMainNavPostsCommentsActive3.png" style="display:none;">
            <img src="ebMainNavPostsComments3.png" style="display:block;">
        </a>
    </div>
</nav></header>
                ...
                <div class="mainFormAreaReview">
                    ...
                    <div id="reviewTopFourDivs">
                        <div id="reviewTopTwoLeftDivs">
                            <div id="reviewMeter">
                                <img src="meterDefault.png" border="0" alt="">
                            </div>
                        ...
                        <div id="reviewTopTwoRightDivs">
                            <div id="reviewLogo">
                                <img src="ebMainHeaderReviews.png" border="0" alt="">
                            </div>
  ...
  <div class="card">
    ...
    <div class="text">04<br>REPORTS</div>
                    ...
                    <div id="reviewsListExplain">
                        <img src="ebReviewsBlurbRedTop.png">
                    </div>
    ...
    <div id="footerback">
        ...
        <img src="ebBackToLc2.png" id="back-button" onclick="backButtonHandler()">
